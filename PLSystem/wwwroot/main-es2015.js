...
/* harmony import */ var _services_plApproval_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/plApproval.service */ "./src/app/services/plApproval.service.ts");
/* harmony import */ var _services_configuration_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/configuration.service */ "./src/app/services/configuration.service.ts");
...
let PLApprovalComponent = class PLApprovalComponent {
    constructor(route, plService, configService, formBuilder, alertify) {
        this.route = route;
    ...
    getPLDetails() {
        this.dataReceived = false;
        this.plService
            .getPLDetails(this.queryForm.get('desk').value, this.queryForm.get('businessDate').value)
            .subscribe(resp => {
            this.plData = resp;
    ...
    sendEmail() {
        this.alertify.confirm('Send email to Front Office?', () => {
            this.plService
                .sendEmail(this.queryForm.get('desk').value, this.queryForm.get('businessDate').value)
                .subscribe(res => {
    ...
    downloadFile() {
        this.alertify.confirm('Download File?', () => {
            this.plService
                .downloadFile(this.type, this.queryForm.get('desk').value, this.queryForm.get('businessDate').value)
                .subscribe(res => {
...
PLApprovalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./PLApproval.component.scss */ "./src/app/PLApproval/PLApproval.component.scss")).default]
    })
], PLApprovalComponent);
...
/* harmony import */ var _resolver_auth_guard_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./resolver/auth.guard.ts */ "./src/app/resolver/auth.guard.ts.ts");
/* harmony import */ var _home_home_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./home/home.component */ "./src/app/home/home.component.ts");
/* harmony import */ var _resolver_desk_resolver__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./resolver/desk.resolver */ "./src/app/resolver/desk.resolver.ts");
...
const routes = [
    {
        ...
        resolve: { desks: _resolver_desk_resolver__WEBPACK_IMPORTED_MODULE_8__["DeskResolver"] },
        ...
        children: [
            {
                ...
                resolve: { desks: _resolver_config_resolver__WEBPACK_IMPORTED_MODULE_5__["ConfigResolver"] },
                runGuardsAndResolvers: 'always',
                canActivate: [_resolver_auth_guard_ts__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
            }
        ]
...
/* harmony import */ var _PLApproval_PLApproval_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./PLApproval/PLApproval.component */ "./src/app/PLApproval/PLApproval.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./guards/prevent-unsaved-changes.guard */ "./src/app/guards/prevent-unsaved-changes.guard.ts");
...
/* harmony import */ var _services_plApproval_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/plApproval.service */ "./src/app/services/plApproval.service.ts");
...
/* harmony import */ var _resolver_auth_guard_ts__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./resolver/auth.guard.ts */ "./src/app/resolver/auth.guard.ts.ts");
/* harmony import */ var _resolver_config_resolver__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./resolver/config.resolver */ "./src/app/resolver/config.resolver.ts");
...
/* harmony import */ var _resolver_CustomHttpInterceptor__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./resolver/CustomHttpInterceptor */ "./src/app/resolver/CustomHttpInterceptor.ts");
/* harmony import */ var _resolver_desk_resolver__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./resolver/desk.resolver */ "./src/app/resolver/desk.resolver.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _PLApproval_PLApproval_component__WEBPACK_IMPORTED_MODULE_8__["PLApprovalComponent"],
        ...
        providers: [
            _guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_11__["PreventUnsavedChangesGuard"],
            _services_configuration_service__WEBPACK_IMPORTED_MODULE_12__["ConfigurationService"],
            _services_plApproval_service__WEBPACK_IMPORTED_MODULE_13__["PlApprovalService"],
            _services_alertify_service__WEBPACK_IMPORTED_MODULE_14__["AlertifyService"],
            _resolver_auth_guard_ts__WEBPACK_IMPORTED_MODULE_15__["AuthGuard"],
            _resolver_config_resolver__WEBPACK_IMPORTED_MODULE_16__["ConfigResolver"],
...
let HomeComponent = class HomeComponent {
    constructor(route, plService, configService, authService, formBuilder) {
        this.route = route;
        this.plService = plService;
        this.configService = configService;
        this.authService = authService;
...
let LoginComponent = class LoginComponent {
    constructor(router, authService, alertify, route) {
        this.router = router;
        this.authService = authService;
        this.alertify = alertify;
        this.route = route;
...
let NavigationComponent = class NavigationComponent {
    constructor(authService, alertify, route) {
        this.authService = authService;
        this.alertify = alertify;
        this.route = route;
    }
...
CustomHttpInterceptor.ctorParameters = () => [
    { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] },
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeskResolver", function() { return DeskResolver; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_plApproval_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/plApproval.service */ "./src/app/services/plApproval.service.ts");
...
let DeskResolver = class DeskResolver {
    constructor(plService, router, authService) {
        this.plService = plService;
        this.router = router;
        this.authService = authService;
    }
...
DeskResolver.ctorParameters = () => [
    { type: _services_plApproval_service__WEBPACK_IMPORTED_MODULE_3__["PlApprovalService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }
];
DeskResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
], DeskResolver);
...
let AuthService = class AuthService {
    ...
    login(model) {
        return this.http
            .post(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].baseUrl + _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].loginUrl, model)
...
let PlApprovalService = class PlApprovalService {
    ...
    getPLDetails(deskId, date) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl +
            'api/pl/' +
    ...
    sendEmail(deskId, date) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl +
            'api/pl/' +
            this.authService.currentUser.userName +
            '/email/' +
            deskId +
    ...
    downloadFile(type, deskId, date) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
        const options = {
            responseType: 'arraybuffer'
        };
        return this.http
            .get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl +
            'api/pl/' +
            this.authService.currentUser.userName +
            '/file/' +
            deskId +
            ...
            '?businessDate=' +
            date, options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((file) => {
            return file;
        }));
    }
    getAllDeskDetails() {
